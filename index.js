...
function updateObjectWithKeyAndValue(inputObject, newKey, newValue) {
  if (null === inputObject || "object" != typeof inputObject) return inputObject;
  var copy = new Object();
...
*/
function destructivelyUpdateObjectWithKeyAndValue(inputObject, inputKey, inputValue) {
