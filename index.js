...
var wakawaka = Object.assign({},key)
return delete wakawaka.key
}
...
When we use dot notation the key is always taken as the literal string provided. We must use bracket notation if we want to access (or delete) values that belong to a variable key.
